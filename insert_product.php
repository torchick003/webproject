...
<html>
    ...
    <body bgcolor="skyblue" style="color:black;">
        <form action="insert_product.php" method="post" enctype="multipart/form-data" style="background-color:white;">
            <table align="center" width="795" border="2" bgcolor="#187eae" style="padding-top: 20px;padding-bottom: 20px">
                ...
                <tr>
                    ...
                    <td><input type="number" name="product_price" required="required"/></td>
                </tr>
                <tr>
                ...
                <tr align="center">
                    <td colspan="7"><br><input type="submit" name="insert_post" value="Insert Now"/></td>
                </tr>
            </table>
        </form>
...
<?php
    if(isset($_POST['insert_post'])){
        ...
        if($insert_pro){
            ...
            echo "<script>window.open('admin0000.php?insert_product','_self')</script>";
        }
    }
?>